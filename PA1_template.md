...
1. Calculate total number of steps/day.
...
![](https://github.com/Heidi24/RepData_PeerAssessment1/blob/master/unnamed-chunk-11-1.png)
...
3. Create a new dataset equal to the original dataset with the missing data filling in.

```{r}
data.table::fwrite(x = activityDT, file = "data/tidyData.csv", quote = FALSE)
```

4. Draw a histogram of the total number of steps/day, and calculate and report the mean and median total number of steps/day. 
...
1. Create a new factor variable in the dataset in two levels: “weekday” and “weekend” indicate whether a given date is a weekday or weekend day.
